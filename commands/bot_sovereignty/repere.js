...
module.exports = {
  name: 'repere',
  // Le loader normalise en minuscules mais conserve les accents : on déclare
  // donc explicitement `repère` afin que .repere, .repère et .rep routent tous
  // vers exactement le même objet commande.
