...
// Les catégories générées par menu-visual doivent réutiliser le nom stocké dans entry/context.
src = src.replace(
...
// ALL MENU : nom réel dans le premier header et espacement stable sur chaque chunk.
src = src.replace(
...
// Ajoute le nom au contexte allmenu après construction de ctx.
