...
if (src.includes(MARKER)) {
  // Même si la cognition est déjà installée, assure le passage du mode adaptatif.
  ...
  console.log('[install-exaucee-cognition] déjà appliqué + mode adaptatif vérifié');
  process.exit(0);
}
...
console.log('[install-exaucee-cognition] ✅ cognition, métacognition, modes adaptatifs et fallback local appliqués');
